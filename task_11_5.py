...
class Warehouse:
    ...
    def __str__(self):
        ...
        string_warehouse = 'Устройства на складе:\n' + string_warehouse if string_warehouse \
            else 'На складе нет устройств'
        string_user = '\n'.join(map(str, (sum(self.user_devices.values(), []))))
        string_user = 'Устройства у пользователей:\n' + string_user if string_user \
            else 'У пользователей устройств нет'
...
def main():
    ...
    print(Warehouse())
    print('******************************')
    printer.change_owner('Иннокентий Шнипперсон')
    print('******************************')
    print(Warehouse())
    print('******************************')
    copier.change_owner('Василий Кроликов')
    print('******************************')
    copier.work()
    print('******************************')
